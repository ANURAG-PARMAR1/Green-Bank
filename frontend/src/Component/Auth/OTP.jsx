...
export function OTP() {
  ...
  const handleVerifyAndSignup = (e) => {
    ...
    dispatch(
      signUp(
        firstName, lastName, email, password, phone, otp, navigate )
      )
  };
      ...
      { loading ? ( <div className="spinner"></div> ) : (
            ...
            <div className="max-w-[500px] p-4 lg:p-8 bg-white rounded-xl">
              ...
              <form onSubmit={handleVerifyAndSignup}>
                ...
                />
                <button onClick={handleVerifyAndSignup} type="submit" className="cursor-pointer text-white uppercase bg-black w-full py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-richblack-900"> Verify Email </button>
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                <button className="flex items-center text-black cursor-pointer gap-x-2" onClick={() => dispatch(sendOtp(signupData.email , navigate))}> <RxCountdownTimer /> Resend it </button>          
              </div>
