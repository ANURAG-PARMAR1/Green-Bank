...
export function Signup() {
  ...
  const handleRegister = (e) => {
    ...
    dispatch(setSignupData(customerDetails))
    dispatch(sendOtp(customerDetails.email, navigate));
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-smoke font-Poppins bg-black">
      <div className="w-[330px] h-[300px] md:w-[500px] md:h-[450px] rounded-lg shadow-2xl bg-white flex flex-col justify-start items-center">
        ...
        <form className="flex flex-col justify-center items-center space-y-4">
          ...
          <button
            ...
            className="bg-black uppercase text-white w-[280px] md:w-[350px] px-8 md:py-3 py-2 mt-4 md:mt-8 rounded-lg text-xl font-semibold hover:scale-110 transition-all ease-in duration-200"
          >
            Signup
          </button>
        ...
        <div className="flex justify-center gap-5 w-full mt-3 md:mt-5 text-sm md:text-base font-Poppins ">
          ...
          <NavLink to="/login">
            <button className="text-color cursor-pointer font-bold uppercase">Login</button>
          </NavLink>
        </div>
      </div>
    </div>
